...
namespace WorkingWithFileSystems
{
    class Program
    {
        ...
        static void WorkWithDirectories()
        {
            ...
            var newFolder = Combine(
            new string[4]{GetFolderPath(SpecialFolder.Personal),
            "Code", "Chapter09", "NewFolder1"});
        ...
        static void WorkWithFiles()
        {
            ...
            string backupFile = Combine(dir, "Dummy.bak.txt");
            ...
            WriteLine($"Random File Name(just file Name): {GetRandomFileName()}");
            WriteLine($"Temporary File Name ready for Written: {GetTempFileName()}");
            ...
            var dInfo = new DirectoryInfo(GetDirectoryName(backupFile));
            WriteLine("-------------------------------------------");
            WriteLine("DirectoryInfo");
            WriteLine("-------------------------------------------");
            WriteLine($"{GetDirectoryName(backupFile)}:");
            WriteLine($"Parent {dInfo.Parent}");
            WriteLine($"Last accessed {dInfo.LastAccessTime}");
        }
